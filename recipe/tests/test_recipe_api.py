...
class PublicRecipeAPITest(TestCase):
    ...
    def test_auth_required(self):
        """Test auth is requird to call API"""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            ...
            title = 'Sample recipe title.',
            link = 'https://example.com/recipe.pdf',
            description = 'Sample reacipe descriptions.'
    ...
    def test_delete_recipe(Self):
        """Testing deleting a recipe succcessfully."""
        recipe = create_recipe(user=Self.user)
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        tag_ethio = Tag.objects.create(user=self.user, name='Indian')
        payload= {
            'title': 'Pongal',
            'time_minutes': 60,
            'price': Decimal('4.50'),
    ...
    def test_create_ingredients_on_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        new_ingedient = Ingredient.objects.get(user=self.user, name='Limes')
        self.assertIn(new_ingedient, recipe.ingredients.all())
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Vigitable')
        r2 =create_recipe(user=self.user, title='Vigetables2')

        tags1 = Tag.objects.create(user=self.user, name='Vegan')
        tags2 = Tag.objects.create(user=self.user, name='Vegiterian')
        r1.tags.add(tags1)
        r2.tags.add(tags2)
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken cacciators')
        ...
        r3 = create_recipe(user=self.user, title='Red Lentile Daal')
