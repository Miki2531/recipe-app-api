...
class RecipeViewSets(viewsets.ModelViewSet):
    ...
    def _params_to_ints(self, qs):
        """Convert a list of strings to intigers."""
        return [int(str_id) for str_id in qs.split(',')]

    def get_queryset(self):
        """Retrive recipes for authenticated user."""
        tags = self.queryset.query_params.get('tags')
        ingredients = self.queryset.query_params.get('ingredients')
    ...
    @action(methods=['POST'], detial=True, url_path='upload-image')
